...
insert into Prodotto (tipo, prezzo, colore, descrizione, marca, modello, taglia, imgurl)
values	("t-shirt", 15, "bianco", "Hakuna Matata T-Shirt", "hz", "normale", "S", "hakunamatata.jpg"),
		("t-shirt", 15, "bianco", "Aereoplano T-Shirt", "hz", "normale", "S", "aereoplano.jpg"),
		("t-shirt", 15, "nero", "Harry Potter T-Shirt", "hz", "normale", "S", "harrypotter.jpg"),
		("t-shirt", 15, "bianco", "Acquarius T-Shirt", "hz", "normale", "S", "acquario.jpg"),
		("t-shirt", 15, "bianco", "McDonalds T-Shirt", "hz", "normale", "S", "mcdonald.jpg"),
		("t-shirt", 15, "nero", "Pavone T-Shirt", "hz", "normale", "S", "pavone.jpg"),
		("t-shirt", 15, "blue", "Rock 'n Roll T-Shirt", "hz", "normale", "S", "rocknroll.jpg"),
        ("prodotto", 8, "bianco", "Coffee Lover", null, null, null, "coffee-borsello.jpg"),
        ("prodotto", 8, "bianco", "Renna", null, null, null, "renna-borsello.jpg"),
        ("prodotto", 8, "bianco", "Rosa", null, null, null, "rosa-borsello.jpg"),
        ("prodotto", 8, "nero", "Cloud", null, null, null, "cloud-cap.jpg"),
        ("prodotto", 8, "nero", "Moon", null, null, null, "moon-cap.jpg"),
        ("prodotto", 5, "bianca", "Disney Shopper", null, null, null, "disney-shopper.jpg"),
        ("prodotto", 5, "bianca", "Peas Shopper", null, null, null, "peas-shopper.jpg"),
        ("prodotto", 5, "bianca", "Cucina Bene Grembiule", null, null, null, "cucina-grembiule.jpg"),
        ("prodotto", 5, "bianca", "Dogs Grembiule", null, null, null, "dogs-grembiule.jpg"),
        ("abbigliamento", 25, "beige", "Rosa Felpa", "hz", "hoodie", "L", "rosa-felpa-beige.jpg"),
        ("abbigliamento", 25, "grigio", "Live Ride Felpa", "hz", "hoodie", "L", "live.jpg");
